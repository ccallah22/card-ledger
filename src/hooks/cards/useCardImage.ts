...
/**
 * Image upload + crop state for the card creation form: raw file selection
 * and validation (handleImageFile), the crop modal's pan/zoom/rotate state
 * and math (clampCropOffset/applyCropRotation), confirming a crop into the
 * final imageUrl (confirmCrop, which also runs the automated image content
